...
| `map_service.generate_map` | map_type, region, zoom | map_data（layers/legend/quality/metadata） | osm/amap/local_geo/geo_service |
...
| `mapStore` | currentMapData/layerGroups/quality/theme | setMapData、sortedLayers、updateLayerStyle |
