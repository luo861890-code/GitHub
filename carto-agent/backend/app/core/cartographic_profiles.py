...
LAYER_CATEGORY: Dict[str, str] = {
    ...
    "核心景点": "core_poi", "景点": "core_poi",
    "文化设施": "normal_poi", "博物馆": "normal_poi", "历史遗迹": "normal_poi",
    "自然景观": "normal_poi", "宗教场所": "normal_poi", "公园绿地": "normal_poi",
    "休闲娱乐": "normal_poi", "旅游服务": "service_poi", "酒店": "service_poi",
    "服务设施": "service_poi", "餐饮": "service_poi", "商业设施": "service_poi",
    # 地势
...
PROFILES: Dict[str, CartographicProfile] = {
    ...
    "traffic": CartographicProfile(
        ...
        # 湖泊点符号是制图综合 E7 坍缩层（小面→点降维），交通图保留以丰富小水体表达
        forbidden=["银行", "餐厅", "快餐", "ATM", "超市", "便利店",
                    "学校", "医院", "警察局", "叠加结果"],
